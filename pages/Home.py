...
layout = html.Div([
    html.H2('How to Use this Tool',style={'text-align':'center'}),
    ...
    html.H3(id='title_hist',style={'textAlign':'center'}),
    ...
    dcc.Dropdown(options=parishes1,multi=True,value=['all'],id='parish_slct',style={'color':"#053F5C"}),
    dcc.Dropdown(options=drop2_opts,value='Disbursement_Type',id='dyn_in',style={'color':"#053F5C"}),
...
def change_data(filter_val,parish):
    ...
    ret_graph.update_layout(legend=dict(orientation='h',yanchor='bottom',y=-0.9))
